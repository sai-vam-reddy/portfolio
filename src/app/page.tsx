...
const ProjectCard = ({
  ...
  <FadeIn delay={delay}>
    <motion.article
      ...
      className="group relative h-full min-h-[310px] rounded-3xl border border-white/10 bg-black/35 backdrop-blur-md p-8 md:p-9 overflow-hidden"
    >
  ...
  return (
    <>
      ...
      >
        ...
        <Section
          id="projects"
          className="border-t border-white/5 pt-40 pb-48"
        >
          <FadeIn>
        ...
        <Section
          id="certificates"
          className="border-t border-white/5 pt-48 pb-48"
        >
          <FadeIn>
            <div className="max-w-3xl mb-14">
              <span className="text-xs uppercase tracking-[0.25em] text-white/25">
